...
//		providerSignInUtils.doPostSignUp(userId, new ServletWebRequest(request));
    ...
    public AdminInfo getAdminInfo(@PathVariable String name) {
        return adminService.getInfo(name);
    }
    ...
    @Value("${spring.security.oauth2.colin.ignore.uri}")
    private String ignoreUri;

    @GetMapping("/get-ignore-uri")
